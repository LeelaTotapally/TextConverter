   ...
   <div className="container-fluid">
     ...
     <div className="collapse navbar-collapse" id="navbarSupportedContent">
       <ul className="navbar-nav me-auto mb-2 mb-lg-0">
         ...
         <input className="form-check-input" type="checkbox" onClick = {props.modecolorfun}role="switch" id="flexSwitchCheckDefault"/>
         <label className="form-check-label" htmlFor="flexSwitchCheckDefault">enable {props.modecolor === 'light' ? 'dark':'light'} mode</label>
